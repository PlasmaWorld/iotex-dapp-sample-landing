...
function Roadmap() {
    return (
        <div id='roadmap' className=' py-24 lg:py-32 text-white'>
            <div className='lg:w-5/6 mx-auto px-7 wxl:px-0'>
                            ...
                            <div className="timeline-end mb-10">
                                ...
                                <ul className='mt-2'>
                                    ...
                                    <li className='flex items-center gap-1 mb-1'>
                                        ...
                                        The beginning of PlasmaW3bWorld Crowdfounding System.
                                        Here we give every Nft Holder the Chance to Start there Buisness. Plasma World foundation Will Recieve 8% of Ownership from every Business.
